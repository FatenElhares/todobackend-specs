...
describe('Cross Origin Requests', function() {
  ...
  it('should allow all origins', function() {
   ...
   // return assert(result, "header").to.contain.key(['access-control-allow-origin']);

return assert(result, "header").to.contain.key('access-control-allow-origin');


    //  console.log('result.headers.access-control-allow-origin');

    //return assert(result, "access-control-allow-origin").to.equal('*');
  });
});
...
describe('Update Todo Item', function() {
  ...
  it('should have completed set to true after PUT update', function() {
    ...
    return assert(result, "ok").to.be.true;
  });
